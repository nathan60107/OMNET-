#
# OMNeT++/OMNEST Makefile for Recording
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -LD:/Desktop/CODING/omnetpp-5.0/omnetpp-5.0/samples/inet/out/$$\(CONFIGNAME\)/src -lINET -KINET_PROJ=D:/Desktop/CODING/omnetpp-5.0/omnetpp-5.0/samples/inet
#

# Name of target to be created (-o option)
TARGET = Recording$(EXE_SUFFIX)
...
INET_PROJ=D:/Desktop/CODING/omnetpp-5.0/omnetpp-5.0/samples/inet
...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f Recording Recording.exe libRecording.so libRecording.a libRecording.dll libRecording.dylib
